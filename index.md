---
article_html: "<img src=\"/steel-toes.png\" alt=\"steel-toes\" width=\"250\" align=right>\n<p><em>a
  ...
  was swapped, if not it will swap it to the branched <code>filepath</code>\nbefore
  ...
  0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
  1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p><code>steel-toes</code>
  is deployed to pypi and can be <code>pip</code> installed.</p>\n<pre class='wrapper'>\n\n<div
  ...
  c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n</div>\n\n<div
  class=\"highlight\"><pre><span></span><span class=\"kn\">from</span> <span class=\"nn\">steel_toes</span>
  <span class=\"kn\">import</span> <span class=\"n\">SteelToes</span>\n\n<span class=\"n\">HOOKS</span>
  <span class=\"o\">=</span> <span class=\"p\">(</span><span class=\"n\">SteelToes</span><span
  class=\"p\">(),)</span>\n</pre></div>\n\n</pre>\n\n<div class=\"admonition note\">\n<p
  class=\"admonition-title\">settings<span/>.py location</p>\n<p><code>settings.py</code>
  is typically located in <code>src/&lt;python_package&gt;/settings.py</code>.</p>\n</div>\n<h3>ignore_types</h3>\n<p>Some
  datasets have a <code>_filepath</code> attribute that is not meant for saving\ndatasets
  to and is not needed to be &quot;branched&quot;, and should be ignored from\nsteel_toes,
  for example <code>SQLQueryDataSet</code>.</p>\n<pre class='wrapper'>\n\n<div class='filepath'>\n<p>settings.py</p>\n\n<div
  class='right'>\n\n<button class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
  ...
  c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n</div>\n\n<div
  class=\"highlight\"><pre><span></span><span class=\"kn\">from</span> <span class=\"nn\">kedro.extras.datasets.pandas.sql_dataset</span>
  <span class=\"kn\">import</span> <span class=\"n\">SQLQueryDataSet</span><span class=\"p\">,</span>
  <span class=\"n\">SQLTableDataSet</span>\n<span class=\"kn\">from</span> <span class=\"nn\">steel_toes</span>
  <span class=\"kn\">import</span> <span class=\"n\">SteelToes</span>\n\n<span class=\"n\">HOOKS</span>
  <span class=\"o\">=</span> <span class=\"p\">(</span><span class=\"n\">SteelToes</span><span
  class=\"p\">(</span><span class=\"n\">ignore_types</span><span class=\"o\">=</span><span
  class=\"p\">[</span><span class=\"n\">SQLQueryDataSet</span><span class=\"p\">,</span>
  <span class=\"n\">SQLTableDataSet</span><span class=\"p\">]),)</span>\n</pre></div>\n\n</pre>\n\n<h2
  id=\"automatic-branch-naming\">Automatic branch naming <a class=\"header-anchor\"
  href=\"#automatic-branch-naming\"><svg class=\"heading-permalink\" aria-hidden=\"true\"
  ...
  3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632 1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p><code>steel_toes</code>
  will automatically get the branch name from your git branch.  All\nyou need to do
  is create a new branch, and steel-toes will make sure that all\nthe data you write
  will go to a specific place for that branch.  It will not\nchange the filepaths
  until the dataset exists or just before its written, this\nway your catalog will
  still load existing datasets from the dataset specified\nin the catalog.</p>\n<pre
  ...
  c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
  \       \n<div class=\"highlight\"><pre><span></span>git<span class=\"w\"> </span>checkout<span
  class=\"w\"> </span>-b<span class=\"w\"> </span>my-new-feature<span class=\"w\">
  </span>origin/main\n</pre></div>\n\n</pre>\n\n<h2 id=\"override-with-environment-variable\">Override
  with environment variable <a class=\"header-anchor\" href=\"#override-with-environment-variable\"><svg
  class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
  height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
  d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
  5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
  ...
  19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997 0
  0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
  1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>In certain situations
  such as using <code>kedro docker</code> in production, there is no\ngit branch to
  pull from. Setting an environment variable before <code>steel-toes</code>\ninitializes
  will set the branch.</p>\n<h3>set environment variable in the shell</h3>\n<pre class='wrapper'>\n\n<div
  class='filepath'>\n<p>run.sh</p>\n\n<div class='right'>\n\n<button class='copy'
  title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  ...
  c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n</div>\n\n<div
  class=\"highlight\"><pre><span></span><span class=\"nv\">STEEL_TOES_BRANCH</span><span
  class=\"o\">=</span><span class=\"s1\">&#39;PROD&#39;</span>\n\n<span class=\"c1\">#
  run kedro here</span>\n</pre></div>\n\n</pre>\n\n<h3>set environment variable with
  python</h3>\n<pre class='wrapper'>\n\n<div class='filepath'>\n<p>run.py</p>\n\n<div
  class='right'>\n\n<button class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  ...
  class=\"p\">[</span><span class=\"s2\">&quot;STEEL_TOES_BRANCH&quot;</span><span
  class=\"p\">]</span> <span class=\"o\">=</span> <span class=\"s2\">&quot;PROD&quot;</span>\n\n<span
  class=\"c1\"># run kedro here</span>\n</pre></div>\n\n</pre>\n\n<h2 id=\"example-filenames\">Example
  filenames <a class=\"header-anchor\" href=\"#example-filenames\"><svg class=\"heading-permalink\"
  aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\" height=\"1em\" viewBox=\"0
  0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M9.199 13.599a5.99
  5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992 5.992 0 0
  0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242 6.003 6.003
  ...
  what filepaths look like when I add parquet catalog\nentries to the spaceflights
  project, <code>steel_toes</code> will add the branch name\nautomatically just before
  ...
  c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
  \       \n<div class=\"highlight\"><pre><span></span><span class=\"nt\">X_test</span><span
  class=\"p\">:</span><span class=\"w\"> </span><span class=\"l l-Scalar l-Scalar-Plain\">data/X_test_main.pq</span>\n<span
  class=\"nt\">X_train</span><span class=\"p\">:</span><span class=\"w\"> </span><span
  class=\"l l-Scalar l-Scalar-Plain\">data/X_train_main.pq</span>\n<span class=\"nt\">preprocessed_companies</span><span
  class=\"p\">:</span><span class=\"w\"> </span><span class=\"l l-Scalar l-Scalar-Plain\">data/02_intermediate/preprocessed_companies_main.pq</span>\n<span
  class=\"nt\">preprocessed_shuttles</span><span class=\"p\">:</span><span class=\"w\">
  </span><span class=\"l l-Scalar l-Scalar-Plain\">data/02_intermediate/preprocessed_shuttles_main.pq</span>\n<span
  class=\"nt\">model_input_table</span><span class=\"p\">:</span><span class=\"w\">
  </span><span class=\"l l-Scalar l-Scalar-Plain\">data/03_primary/model_input_table_main.pq</span>\n<span
  class=\"nt\">regressor</span><span class=\"p\">:</span><span class=\"w\"> </span><span
  class=\"l l-Scalar l-Scalar-Plain\">data/06_models/regressor_main.pickle</span>\n</pre></div>\n\n</pre>\n\n<h2
  id=\"logs-on-first-run\">Logs on first run <a class=\"header-anchor\" href=\"#logs-on-first-run\"><svg
  class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
  height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
  d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
  5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
  ...
  19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997 0
  0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
  1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>When first running your
  pipeline with <code>steel-toes</code> it will start the\n<code>_filepath</code>
  swap <strong>after_node_run</strong>, since the swapped file does not yet exist.</p>\n<div
  class=\"admonition note\">\n<p class=\"admonition-title\">Note</p>\n<p>At this point
  catalog.load('preprocessed_shuttles') will <strong>not</strong> load the\nbranched
  dataset.</p>\n</div>\n<pre class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button
  class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  ...
  c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
  \       \n<div class=\"highlight\"><pre><span></span>❯<span class=\"w\"> </span>kedro<span
  class=\"w\"> </span>run\nINFO<span class=\"w\">     </span>Kedro<span class=\"w\">
  </span>project<span class=\"w\"> </span>spaceflights<span class=\"w\">                                                               </span>session.py:340\n...\nINFO<span
  class=\"w\">     </span>STEEL_TOES:after_node_run<span class=\"w\"> </span><span
  class=\"s1\">&#39;preprocessed_shuttles.pq&#39;</span><span class=\"w\"> </span>-&gt;<span
  class=\"w\"> </span><span class=\"s1\">&#39;preprocessed_shuttles_main.pq&#39;</span><span
  class=\"w\">  </span>steel_toes.py:102\n...\nINFO<span class=\"w\">     </span>Completed<span
  class=\"w\"> </span><span class=\"m\">6</span><span class=\"w\"> </span>out<span
  class=\"w\"> </span>of<span class=\"w\"> </span><span class=\"m\">6</span><span
  class=\"w\"> </span>tasks<span class=\"w\">                                                               </span>sequential_runner.py:85\nINFO<span
  class=\"w\">     </span>Pipeline<span class=\"w\"> </span>execution<span class=\"w\">
  </span>completed<span class=\"w\"> </span>successfully.<span class=\"w\">                                               </span>runner.py:90\n</pre></div>\n\n</pre>\n\n<h2
  id=\"logs-after-dataset-exists\">Logs after dataset exists <a class=\"header-anchor\"
  href=\"#logs-after-dataset-exists\"><svg class=\"heading-permalink\" aria-hidden=\"true\"
  fill=\"currentColor\" focusable=\"false\" height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\"
  xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949
  2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992 5.992 0 0 0 1.695-4.285 5.976
  5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242 6.003 6.003 0 0 0-1.905 1.24l-1.731
  ...
  3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997 0 0 1-.111-5.644l3.005-3.006a3.982
  3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632 1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>Subsequent
  runs of kedro will swap the dataset to the branched filepath\nimmediately after
  the catalog has been created.</p>\n<div class=\"admonition note\">\n<p class=\"admonition-title\">Note</p>\n<p>Now
  catalog.load('preprocessed_shuttles') <strong>will</strong> load the branched dataset.</p>\n</div>\n<pre
  class='wrapper'>\n\n<div class='copy-wrapper'>\n\n<button class='copy' title='copy
  code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  ...
  c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n
  \       \n<div class=\"highlight\"><pre><span></span>INFO<span class=\"w\">     </span>Kedro<span
  class=\"w\"> </span>project<span class=\"w\"> </span>spaceflights<span class=\"w\">
  \                                                                     </span>session.py:340\n...\nINFO<span
  class=\"w\">     </span>STEEL_TOES:after_catalog_created<span class=\"w\"> </span><span
  class=\"s1\">&#39;preprocessed_shuttles.pq&#39;</span><span class=\"w\"> </span>-&gt;<span
  class=\"w\"> </span><span class=\"s1\">&#39;preprocessed_shuttles_main.pq&#39;</span><span
  class=\"w\">  </span>steel_toes.py:102\n...\nINFO<span class=\"w\">     </span>Completed<span
  class=\"w\"> </span><span class=\"m\">6</span><span class=\"w\"> </span>out<span
  ...
  Usage</h3>\n<p>The CLI provides a handy interface to clean up your branched datasets.</p>\n<pre
  class='wrapper'>\n\n<div class='filepath'>\n<p>steel-toes --help</p>\n\n<div class='right'>\n\n<button
  class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  ...
  c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n</div>\n\n<div
  class=\"highlight\"><pre><span></span>Usage:<span class=\"w\"> </span>steel-toes<span
  class=\"w\"> </span><span class=\"o\">[</span>OPTIONS<span class=\"o\">]</span><span
  class=\"w\"> </span>COMMAND<span class=\"w\"> </span><span class=\"o\">[</span>ARGS<span
  class=\"o\">]</span>...\n\n<span class=\"w\">  </span><span class=\"nb\">help</span>\n\nOptions:\n<span
  class=\"w\">  </span>-V,<span class=\"w\"> </span>--version<span class=\"w\">  </span>Prints<span
  class=\"w\"> </span>version<span class=\"w\"> </span>and<span class=\"w\"> </span>exits\n<span
  ...
  </span>exit.\n\nCommands:\n<span class=\"w\">  </span>clean-branch<span class=\"w\">
  \ </span>finds<span class=\"w\"> </span>branch<span class=\"w\"> </span>datasets<span
  class=\"w\"> </span>and<span class=\"w\"> </span>removes<span class=\"w\"> </span>them\n</pre></div>\n\n</pre>\n\n<p><code>steel-toes</code>
  also registers itself as a <code>kedro</code> global cli plugin. You can run\n<code>kedro
  clean-branch</code> to clean your branched data.</p>\n<pre class='wrapper'>\n\n<div
  class='filepath'>\n<p>steel-toes clean-branch --help</p>\n\n<div class='right'>\n\n<button
  class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
  ...
  c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n</div>\n\n<div
  class=\"highlight\"><pre><span></span>Usage:<span class=\"w\"> </span>kedro<span
  class=\"w\"> </span>clean-branch<span class=\"w\"> </span><span class=\"o\">[</span>OPTIONS<span
  class=\"o\">]</span>\n\n<span class=\"w\">  </span>finds<span class=\"w\"> </span>branch<span
  class=\"w\"> </span>datasets<span class=\"w\"> </span>and<span class=\"w\"> </span>removes<span
  class=\"w\"> </span>them\n\nOptions:\n<span class=\"w\">  </span>--dryrun<span class=\"w\">
  \                  </span>Displays<span class=\"w\"> </span>the<span class=\"w\">
  </span>files<span class=\"w\"> </span>that<span class=\"w\"> </span>would<span class=\"w\">
  </span>be<span class=\"w\"> </span>deleted<span class=\"w\"> </span>using\n<span
  class=\"w\">                             </span>the<span class=\"w\"> </span>specified<span
  class=\"w\"> </span><span class=\"nb\">command</span><span class=\"w\"> </span>without<span
  class=\"w\"> </span>actually<span class=\"w\"> </span>deleting\n<span class=\"w\">
  \                            </span>them.\n\n<span class=\"w\">  </span>-b,<span
  class=\"w\"> </span>--branch<span class=\"w\"> </span>TEXT<span class=\"w\">          </span>git<span
  class=\"w\"> </span>branch<span class=\"w\"> </span>to<span class=\"w\"> </span>clean<span
  class=\"w\"> </span>files<span class=\"w\"> </span>from\n<span class=\"w\">  </span>-h,<span
  class=\"w\"> </span>--help<span class=\"w\">                 </span>Show<span class=\"w\">
  </span>this<span class=\"w\"> </span>message<span class=\"w\"> </span>and<span class=\"w\">
  </span>exit.\n</pre></div>\n\n</pre>\n\n<h2 id=\"cleaning-up-old-branches\">Cleaning
  up old branches <a class=\"header-anchor\" href=\"#cleaning-up-old-branches\"><svg
  class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
  height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
  d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
  5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
  ...
  19.81a3.985 3.985 0 0 1-2.761 1.123 3.975 3.975 0 0 1-2.799-1.122 3.997 3.997 0
  0 1-.111-5.644l3.005-3.006a3.982 3.982 0 0 1 3.395-1.126 3.987 3.987 0 0 1 2.632
  1.563 1 1 0 0 0 1.602-1.198z\"></path></svg></a></h2>\n<p>To clean up your current
  branch, running <code>kedro clean-branch</code> will remove all\nthe datasets that
  have been swapped to the current branch. Adding <code>--dryrun</code>\nwill only
  log what <code>steel-toes</code> intends to do, and will not delete.</p>\n<pre class='wrapper'>\n\n<div
  class='filepath'>\n<p>kedro clean-branch --dryrun</p>\n\n<div class='right'>\n\n<button
  class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
  ...
  c-0.61,0.61-1,1.46-1,2.37h0.02v0.01v73.27v0.02h-0.02c0,0.91,0.39,1.75,1.01,2.37c0.61,0.61,1.46,1,2.37,1v-0.02h0.01h61.7h0.02
  v0.02c0.91,0,1.75-0.39,2.37-1.01c0.61-0.61,1-1.46,1-2.37h-0.02V108.92L105.18,108.92z\"/></g></svg></button>\n</div>\n</div>\n\n<div
  class=\"highlight\"><pre><span></span>INFO<span class=\"w\">     </span>STEEL_TOES:after_catalog_created<span
  class=\"w\"> </span><span class=\"s1\">&#39;preprocessed_shuttles.pq&#39;</span><span
  class=\"w\"> </span>-&gt;<span class=\"w\"> </span><span class=\"s1\">&#39;preprocessed_shuttles_main.pq&#39;</span><span
  class=\"w\">                                         </span>steel_toes.py:102\n...\nINFO<span
  class=\"w\">     </span>STEEL_TOES:dryrun-remove<span class=\"w\"> </span><span
  class=\"p\">|</span><span class=\"w\"> </span><span class=\"s1\">&#39;/home/waylon/git/spaceflights/data/02_intermediate/preprocessed_shuttles_main.pq&#39;</span><span
  class=\"w\">                          </span>steel_toes.py:141\n</pre></div>\n\n</pre>\n\n<p>Dropping
  the <code>--dryrun</code> flag will delete all the branched datasets.</p>\n<pre
  class='wrapper'>\n\n<div class='filepath'>\n<p>kedro clean-branch</p>\n\n<div class='right'>\n\n<button
  class='copy' title='copy code to clipboard' onclick=\"navigator.clipboard.writeText(this.parentElement.parentElement.querySelector('pre').textContent)\"><svg
  version=\"1.1\" id=\"Layer_1\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\"
  x=\"0px\" y=\"0px\" viewBox=\"0 0 115.77 122.88\" style=\"enable-background:new
  0 0 115.77 122.88\" xml:space=\"preserve\"><style type=\"text/css\">.st0{fill-rule:evenodd;clip-rule:evenodd;}</style><g><path
  ...
  class=\"w\"> </span>-&gt;<span class=\"w\"> </span><span class=\"s1\">&#39;preprocessed_shuttles_main.pq&#39;</span><span
  class=\"w\">                                         </span>steel_toes.py:102\n...\nINFO<span
  class=\"w\">     </span>STEEL_TOES:deleting<span class=\"w\"> </span><span class=\"p\">|</span><span
  class=\"w\"> </span><span class=\"s1\">&#39;/home/waylon/git/spaceflights/data/02_intermediate/preprocessed_shuttles_main.pq&#39;</span><span
  class=\"w\">                          </span>steel_toes.py:141\n</pre></div>\n\n</pre>\n\n<h2
  id=\"contributing\">Contributing <a class=\"header-anchor\" href=\"#contributing\"><svg
  class=\"heading-permalink\" aria-hidden=\"true\" fill=\"currentColor\" focusable=\"false\"
  height=\"1em\" viewBox=\"0 0 24 24\" width=\"1em\" xmlns=\"http://www.w3.org/2000/svg\"><path
  d=\"M9.199 13.599a5.99 5.99 0 0 0 3.949 2.345 5.987 5.987 0 0 0 5.105-1.702l2.995-2.994a5.992
  5.992 0 0 0 1.695-4.285 5.976 5.976 0 0 0-1.831-4.211 5.99 5.99 0 0 0-6.431-1.242
...
html: "<img src=\"/steel-toes.png\" alt=\"steel-toes\" width=\"250\" align=right>\n<p><em>a
  ...
  under the MIT License - see the <a href=\"./LICENSE\">LICENSE</a>.\nfile for details</p>\n"
jinja: false
long_description: steel-toes kedro steel-toes When your project creates a catalog  After
  your node is ran, before saving,  steel-toes For a real kedro project you should
  add to your requirements. To add  ! Some datasets have a  steel_toes In certain
  situations such as
now: 2023-03-25 17:04:13.161534
path: pages/index.md
published: true
slug: index
super_description: steel-toes kedro steel-toes When your project creates a catalog  After
  your node is ran, before saving,  steel-toes For a real kedro project you should
  add to your requirements. To add  ! Some datasets have a  steel_toes In certain
  situations such as using  Here is an example of what filepaths look like when I
  add parquet catalog When first running your pipeline with  ! Subsequent runs of
  kedro will swap the dataset to the branched filepath ! The CLI provides a handy
  interface to clean up your b
tags:
- home
- meta
templateKey: ''
